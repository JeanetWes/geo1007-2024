...
function registerGeoLocate(mapInstance) {
  ...
  mapInstance.on('locationerror', onLlab5/LocationError);
}

//registerGeoLocate(map) (the geo locate funcion had to be diasbled to display the Point of Interest layer)
